...
const Toast = props => {
  ...
  const panResponderRef = (0, _react.useRef)(undefined);
  const panResponderAnimRef = (0, _react.useRef)(undefined);
  ...
  const animationStyle = {
    ...
    }, ...(swipeEnabled ? [getPanResponderAnim().getTranslateTransform()[0]] : []), ...(animationType === "zoom-in" ? [{
